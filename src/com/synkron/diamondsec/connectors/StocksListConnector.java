 ...
 *
 */
public class StocksListConnector extends InfowareConnector{
	private static final String TAG = "StocksListConnector";
	...
	public StocksListConnector(Context context){
		super(context);
	}
	protected String doInBackground(String ...args){
		Log.i(TAG, "Stocks List Task Started");
		String _Result = "";
		String sb = "";
		try {
	...
	protected void onPostExecute(String result) {
		...
		Log.i(TAG, "StocksList Task Completed");
